        ...
        <main className="mx-auto flex min-h-screen max-w-4xl items-center px-4 py-16 sm:px-6">
          <div>
            ...
            <h1 className="mt-4 text-4xl font-black tracking-tight sm:text-5xl">
              {isServerActionVersionMismatch ? "Esta página pertence a uma versão anterior." : "A loja encontrou um erro temporário."}
            </h1>
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              {isServerActionVersionMismatch ? (
                <button type="button" onClick={() => window.location.reload()} className="min-h-12 rounded-md bg-black px-5 text-xs font-black uppercase tracking-[0.16em] text-white">Atualizar página</button>
              ) : (
