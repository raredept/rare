...
export const homeHeroSlides = [
  {
    ...
    description: "Importados premium, pecas de presenca e estoque controlado para quem acompanha cultura de rua.",
  ...
  },
  {
    ...
    description: "Camisetas, jaquetas, conjuntos e acessorios escolhidos para composicoes de impacto.",
  ...
  },
  {
    ...
    title: "Pecas internacionais para elevar o outfit",
    description: "Uma selecao direta, sem excesso, pensada para compra rapida e segura.",
